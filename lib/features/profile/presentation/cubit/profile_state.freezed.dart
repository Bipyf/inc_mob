...
class _$_ProfileState implements _ProfileState {
  const _$_ProfileState({final List<EmployeeModel>? incontrolLevelsList})
  ...
  @override
  String toString() {
    return 'ProfileState(incontrolLevelsList: $incontrolLevelsList)';
  }
...
abstract class _ProfileState implements ProfileState {
  const factory _ProfileState(
      {final List<EmployeeModel>? incontrolLevelsList}) = _$_ProfileState;
