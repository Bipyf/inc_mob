...
/// @nodoc
mixin _$HomeState {
  List<PositionModel> get incontrolLevelsList =>
...
abstract class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<PositionModel> incontrolLevelsList});
}
...
class _$_HomeState implements _HomeState {
  const _$_HomeState(
      {final List<PositionModel> incontrolLevelsList = const []})
      : _incontrolLevelsList = incontrolLevelsList;

  final List<PositionModel> _incontrolLevelsList;
  @override
  @JsonKey()
  List<PositionModel> get incontrolLevelsList {
  ...
  @override
  String toString() {
    return 'HomeState(incontrolLevelsList: $incontrolLevelsList)';
  }
...
abstract class _HomeState implements HomeState {
  const factory _HomeState({final List<PositionModel> incontrolLevelsList}) =
      _$_HomeState;
